...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/feedjira/feedjira/blob/master/CHANGELOG.md", "homepage_uri" => "http://feedjira.com", "source_code_uri" => "https://github.com/feedjira/feedjira" } if s.respond_to? :metadata=
